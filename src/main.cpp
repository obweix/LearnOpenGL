...
std::string PIC_1_LOCATION ="/Users/wbxie/userwbxie/code/LearnOpenGL/assets/zjy.jpg";
...
int main(int argc, char * argv[])
{
    ...
    // ------------------------------------
    auto vsPath = GLOBAL_EXE_DIR + "6.1.coordinate_systems.vs";
    auto fsPath = GLOBAL_EXE_DIR + "6.1.coordinate_systems.fs";
